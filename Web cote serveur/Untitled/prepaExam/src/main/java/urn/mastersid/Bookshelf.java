...
public class Bookshelf {
	...
	private void populate() {
		...
		this.books.add(new Book("Solar Lottery", "Philip K. Dick", "The first book of PKD and one of the best", 3.5));
		...
		this.books.add(new Book("Harry Potter and the Philosopher's Stone", "J.K. Rowling", "", 4));
		...
		this.books.add(new Book("Harry Potter and the Chamber of Secrets", "J.K. Rowling", "", 4));
		...
		this.books.add(new Book("Harry Potter and the Prisoner of Azkaban", "J.K. Rowling", "", 4));
		...
		this.books.add(new Book("Harry Potter and the Goblet of Fire", "J.K. Rowling", "", 4));
		this.books.add(new Book("Les misérables", "Victor Hugo", "Long but beautiful", 4.21));
		this.books.add(new Book("Harry Potter and the Order of the Phoenix", "J.K. Rowling", "", 4));
		this.books.add(new Book("The Iliad", "Homer", "", 3.91));
		this.books.add(new Book("Harry Potter and the Half-Blood Prince", "J.K. Rowling", "", 4));
		this.books.add(new Book("Harry Potter and the Deathly Hallows", "J.K. Rowling", "", 4));
		this.books.add(new Book("1984", "George Orwell", "Terrifying, brutal, intricate, prophetic, GENIUS!", 4.19));
		
	}
	
	private void validate(Book book) throws InvalidBookException  {
